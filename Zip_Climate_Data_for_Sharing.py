...
zipfolder = root + "05_Climate_Change_Simulations/UKCP18rcm_220708_APM_UK/Bias Controlled Climate Zipfiles/"
...
for m in models:
    ...
    with open(zipfolder + m + '_climate_data_summary.txt', 'w') as f:
